...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    -- Reward
    local reward = {
        itemId = 43878 -- Replace with the ID of the item you want to give as a reward
    }
	...
	--itens conforme a arma
		{id = 47371, count = 1}, -- amber bow
        {id = 43877, count = 1}, -- sanguine bow
        {id = 39161, count = 1}, -- feverbloom boots
		{id = 34088, count = 1}, -- soulbleeder
		{id = 28718, count = 1}, -- falcon bow
		{id = 34150, count = 1}, -- lion longbow
		{id = 31581, count = 1}, -- bow of cataclysm
		{id = 36665, count = 1}, -- gilded eldritch bow
		{id = 36664, count = 1}, -- eldritch bow
		{id = 29417, count = 1}, -- living vine bow
		{id = 20084, count = 1}, -- umbral master bow
		{id = 31617, count = 1}, -- winged boots
...
craftGrandSanguineCrossbow:position({ x = 32351, y = 32183, z = 7 }) --(32351, 32183, 7)
