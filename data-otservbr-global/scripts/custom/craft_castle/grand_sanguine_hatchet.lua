...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    -- Reward
    local reward = {
        itemId = 43869 -- Replace with the ID of the item you want to give as a reward
    }
	...
	--itens conforme a arma
		{id = 47375, count = 1}, -- amber axe
        {id = 43868, count = 1}, -- sanguine hatchet
        ...
        {id = 20072, count = 1}, -- umbral master axe
...
craftGrandSanguineCrossbow:position({ x = 32342, y = 32185, z = 5 }) --(32342, 32185, 5)
