...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    -- Reward
    local reward = {
        itemId = 43873 -- Replace with the ID of the item you want to give as a reward
    }
	...
	--itens conforme a arma
		{id = 47370, count = 1}, -- amber bludgeon	
        {id = 43872, count = 1}, -- sanguine bludgeon
		{id = 34087, count = 1}, -- soulmaimer  
		{id = 28725, count = 1}, -- falcon mace  
		{id = 34254, count = 1}, -- lion hammer  
		{id = 39157, count = 1}, -- naga club  
		{id = 36660, count = 1}, -- gilded eldritch warmace  
		{id = 36659, count = 1}, -- eldritch warmace  
		{id = 30395, count = 1}, -- cobra club  
		{id = 31580, count = 1}, -- mortal mace  
		{id = 29419, count = 1}, -- resizer 
        {id = 20081, count = 1}, -- umbral master hammer
        {id = 27454, count = 1}, -- hammer of destruction
...
craftGrandSanguineCrossbow:position({ x = 32351, y = 32181, z = 5 }) --(32351, 32181, 5)
