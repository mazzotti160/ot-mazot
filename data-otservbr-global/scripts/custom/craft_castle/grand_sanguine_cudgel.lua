...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    -- Reward
    local reward = {
        itemId = 43867 -- Replace with the ID of the item you want to give as a reward
    }
	...
	--itens conforme a arma
		{id = 47376, count = 1}, -- amber cudgel
        {id = 43866, count = 1}, -- sanguine cudgel
        ...
        {id = 20078, count = 1}, -- umbral master mace
...
craftGrandSanguineCrossbow:position({ x = 32342, y = 32181, z = 5 }) --(32342, 32181, 5)
