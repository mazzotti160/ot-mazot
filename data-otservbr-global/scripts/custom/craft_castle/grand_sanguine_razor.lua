...
function craftGrandSanguineCrossbow.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    -- Reward
    local reward = {
        itemId = 43871 -- Replace with the ID of the item you want to give as a reward
    }
	...
	--itens conforme a arma
		{id = 47368, count = 1}, -- amber slayer
        {id = 43870, count = 1}, -- sanguine razor
        ...
        {id = 20069, count = 1}, -- umbral master slayer
        {id = 27450, count = 1}, -- slayer of destruction
...
craftGrandSanguineCrossbow:position({ x = 32351, y = 32183, z = 5 }) --(32351, 32183, 5)
