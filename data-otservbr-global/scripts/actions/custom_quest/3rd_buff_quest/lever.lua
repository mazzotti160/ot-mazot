...
local config = {
    boss = {
        name = "Mystic Megalomania",
        position = Position(2192, 2090, 7),
    },
    playerPositions = {
		{ pos = Position(2190, 2090, 6), teleport = Position(2192, 2086, 7), effect = CONST_ME_TELEPORT },
		{ pos = Position(2191, 2090, 6), teleport = Position(2192, 2086, 7), effect = CONST_ME_TELEPORT },
		{ pos = Position(2192, 2090, 6), teleport = Position(2192, 2086, 7), effect = CONST_ME_TELEPORT },
		{ pos = Position(2193, 2090, 6), teleport = Position(2192, 2086, 7), effect = CONST_ME_TELEPORT },
		{ pos = Position(2194, 2090, 6), teleport = Position(2192, 2086, 7), effect = CONST_ME_TELEPORT },
    },
    specPos = {
		from = Position(2183, 2083, 7),
		to = Position(2201, 2096, 7),
    },
...
local function removeMonsterFromArea(fromPos, toPos)
    local exitPosition = Position(2192, 2095, 7) --exit = Position(2152, 2097, 7),
