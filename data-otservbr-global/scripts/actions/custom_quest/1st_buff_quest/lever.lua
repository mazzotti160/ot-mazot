...
local config = {
    boss = {
        name = "Magical Grand Master Oberon",
        position = Position(2110, 2092, 7), --{x = 2110, y = 2092, z = 7}
    },
    playerPositions = {
        { pos = Position(2108, 2092, 6), teleport = Position(2110, 2088, 7) }, --{x = 2108, y = 2092, z = 6}
        { pos = Position(2109, 2092, 6), teleport = Position(2110, 2088, 7) },
        { pos = Position(2110, 2092, 6), teleport = Position(2110, 2088, 7) },
        { pos = Position(2111, 2092, 6), teleport = Position(2110, 2088, 7) },
        { pos = Position(2112, 2092, 6), teleport = Position(2110, 2088, 7) },
    },
    specPos = {
        from = Position(2102, 2086, 7),
        to = Position(2118, 2098, 7),
    },
...
local function removeMonsterFromArea(fromPos, toPos)
    local exitPosition = Position(2110, 2097, 7)
