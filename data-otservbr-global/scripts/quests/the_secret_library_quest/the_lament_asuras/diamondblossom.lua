local config = {
    [49662] = {
        bossName = "The Diamond Blossom", -- boss name
        bossPos = Position(32882, 32795, 11), -- Boss Position
        centerPos = Position(32882, 32795, 11), -- Boss Position
        newPos = Position(32886, 32795, 11), -- Where to teleport player when entering the room
        exitPos = Position(32858, 32767, 10), -- Exit outside Position
        rangeX = 6, -- Range in X
        rangeY = 6, -- Range in Y
        time = 10, -- time in minutes to remove the player
    },
    playerPos = Position(32882, 32790, 11), -- Player Position
