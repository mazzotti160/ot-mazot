local config = {
    [49663] = {
        bossName = "The Lily of Night", -- boss name
        bossPos = Position(32857, 32744, 11), -- Boss Position
        centerPos = Position(32857, 32744, 11), -- Boss Position
        newPos = Position(32857, 32741, 11), -- Where to teleport player when entering the room
        exitPos = Position(32818, 32781, 11), -- Exit outside Position
        rangeX = 6, -- Range in X
        rangeY = 6, -- Range in Y
        time = 10, -- time in minutes to remove the player
    },
    playerPos = Position(32857, 32739, 11), -- Player Position
