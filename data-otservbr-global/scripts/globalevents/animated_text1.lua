...
--teleport dentro do templo
    ...
    {position = Position(32365, 32231, 7), text = 'Trainers', effect = 176},		
    {position = Position(32365, 32233, 7), text = 'Hunts', effect = 176},	
    {position = Position(32365, 32235, 7), text = 'Quests', effect = 176},	
	{position = Position(32365, 32237, 7), text = 'Depot', effect = 176},	
	{position = Position(32365, 32239, 7), text = 'Exercise', effect = 176},	
