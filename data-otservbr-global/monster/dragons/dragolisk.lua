...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 27, type = COMBAT_PHYSICALDAMAGE, minDamage = -440, maxDamage = -500, length = 7, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -500, radius = 4, effect = CONST_ME_POFF, target = true },
	{ name = "death chain", interval = 2000, chance = 20, minDamage = -500, maxDamage = -600, range = 7 },
}
