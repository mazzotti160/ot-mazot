...
monster.loot = {
	{ name = "darklight core", chance = 7577, maxCount = 1 },
	{ name = "darklight obsidian axe", chance = 13338, maxCount = 1 },
	{ name = "crystal coin", chance = 13887, maxCount = 1 },
	{ name = "darklight matter", chance = 10308, maxCount = 1 },
	{ name = "wand of starstorm", chance = 6721, maxCount = 1 },
	{ name = "blue gem", chance = 12557, maxCount = 1 },
	{ name = "ultimate health potion", chance = 11779, maxCount = 5 },
	{ name = "focus cape", chance = 12849, maxCount = 1 },
	{ name = "white gem", chance = 6793, maxCount = 1 },
}
