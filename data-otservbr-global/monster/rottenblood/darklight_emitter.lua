...
monster.loot = {
	{ name = "crystal coin", chance = 10668, maxCount = 1 },
	{ name = "amber staff", chance = 9630, maxCount = 1 },
	{ name = "darklight obsidian axe", chance = 8615, maxCount = 1 },
	{ name = "small topaz", chance = 7000, maxCount = 1 },
	{ name = "darklight core", chance = 14911, maxCount = 1 },
	{ name = "zaoan armor", chance = 9714, maxCount = 1 },
	{ name = "basalt crumbs", chance = 10450, maxCount = 1 },
	{ id = 3039, chance = 5767, maxCount = 1 }, -- red gem
}
