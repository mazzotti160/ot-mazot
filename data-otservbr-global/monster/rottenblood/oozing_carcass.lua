...
monster.loot = {
	{ name = "crystal coin", chance = 5884, maxCount = 1 },
	{ name = "rotten roots", chance = 9871, maxCount = 1 },
	{ name = "small emerald", chance = 12246, maxCount = 1 },
	{ name = "lichen gobbler", chance = 13729, maxCount = 1 },
	{ id = 3039, chance = 9281, maxCount = 1 }, -- red gem
	{ name = "skull staff", chance = 13266, maxCount = 1 },
	{ name = "bone shield", chance = 6054, maxCount = 1 },
	{ name = "yellow gem", chance = 9906, maxCount = 1 },
	{ name = "decayed finger bone", chance = 9995, maxCount = 1 },
	{ name = "ultimate health potion", chance = 12929, maxCount = 2 },
	{ name = "bloody edge", chance = 11802, maxCount = 1 },
	{ name = "spellbook of warding", chance = 8658, maxCount = 1 },
}
