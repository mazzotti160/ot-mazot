...
monster.loot = {
	{ name = "crystal coin", chance = 13013, maxCount = 1 },
	{ name = "darklight core", chance = 11464, maxCount = 1 },
	{ name = "darklight obsidian axe", chance = 11997, maxCount = 1 },
	{ name = "dark obsidian splinter", chance = 10513, maxCount = 1 },
	{ id = 3039, chance = 10209, maxCount = 1 }, -- red gem
	{ name = "small emerald", chance = 13509, maxCount = 3 },
	{ name = "zaoan shoes", chance = 7098, maxCount = 1 },
	{ name = "magma amulet", chance = 14800, maxCount = 1 },
	{ name = "small ruby", chance = 6599, maxCount = 3 },
}
