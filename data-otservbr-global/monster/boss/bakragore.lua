...
monster.loot = {
	...
	{ id = 43895, chance = 10570, maxcount = 10 }, -- red gem
	...
	{ id = 43895, chance = 120 }, -- Bag you covet
	{ id = 43968, chance = 570, maxcount = 1 }, -- bakra amalgamation
...
monster.attacks = {
	...
	{ name = "combat", interval = 3000, chance = 35, type = COMBAT_ICEDAMAGE, minDamage = -2700, maxDamage = -3200, range = 7, radius = 7, shootEffect = CONST_ANI_ICE, effect = 243, target = true },
	...
	{ name = "combat", interval = 3000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -2500, maxDamage = -3500, length = 8, spread = 0, effect = 249, target = false },
