...
-- MazOT CATEGORIA ~ Utilitarios


-- -- MazOT CATEGORIA ~ MAZOT
{
    icons = { "Category_Mazot.png" },
    name = "MazOT",
    rookgaard = true,
    subclasses = { "Utilitarios", "Custom", "Bags", "Buffs" },
},

{
    icons = { "Utility_Icon.png" },  -- Substitua pelo ícone desejado
    name = "Utilitarios",
    parent = "MazOT",
    rookgaard = true,
    state = GameStore.States.STATE_NONE,
...
--cupcakes
		{			              
            ...
            movable = true,   			
            count = 25,
            description = "{info}25 gold tokens.",
 ...
 {              
            ...
            itemtype = 22721,   
			            movable = true,   
            count = 125,
            description = "{info}125 gold tokens.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 	
		{			              
            icons = { "Gold_Pouch.png" },
 ...
 {              
		...
		{			              
            ...
            movable = true,   			
            count = 1,
            description = "{info}Fills all your mana.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 
		{			              
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,   			
            count = 1,
            description = "{info}Grants you 24 fist fighting and 12 of your vocations skill per 1 hour. Mages = ml, EK = sword, club, axe, RP = distance.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 	
			{			              
            icons = { "Gold_Pouch.png" },
 ...
 {              
		...
		{			              
            ...
            movable = true,   			
            count = 1,
            description = "{info}Fills all your health.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 
 {              
            icons = { "Gold_Pouch.png" },
...
--end cupcakes				
		{			              
            ...
            movable = true,   			
            count = 2,
            description = "{info}Use it to boost your forge attempts.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 
 {              
            icons = { "Gold_Pouch.png" },
 ...
 {              
            ...
            itemtype = 8778,   
            count = 1,
            description = "{info}Use it to unlock an ingame obtained addon! 1 doll per full outfit. Mage Hat not included and store addons not included!",
 ...
 {              
            ...
            itemtype = 25979,   
            count = 1,
            description = "{info}Use this item to ride a mount obtained ingame! 1 doll per mount.! Store mounts not included!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        }, 
        {              
            icons = { "Gold_Pouch.png" },
            ...
            movable = true, 
            count = 1,
            description = "{info}Canivete Rosa!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  
        {              
            icons = { "Gold_Pouch.png" },
            ...
            movable = true, 
            count = 1,
            description = "{info}Canivete Vermelho!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  
        {              
            icons = { "Gold_Pouch.png" },
            ...
            movable = true, 
            count = 1,
            description = "{info}Canivete Azul!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },     
...

{
    ...
    offers = {	
		{			              
            icons = { "Battlepass.png" },
            name = "Battlepass",
            price = 7900,                
            itemtype = 48578,   
			movable = false,
            count = 1,
            description = "{info}Check discord for more information! You win several rewards each 20 hours. It has 30 charges.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
        }, 		
	
		{			              
            icons = { "Golden_Newspaper.png" },
            name = "Permission Lootseller",
            price = 450,                
            itemtype = 8153,   
			movable = false,
            count = 1,
            description = "{info}Carrying this item in your backpack allow you to trade with npc Lootseller. This item cannot be moved out from your store inbox.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
        }, 			
 {              
            icons = { "Gold_Pouch.png" },
            name = "Attacker Eye of the Storm",
            price = 900,                
            itemtype = 19369, 
			movable = true,			
            count = 1,
            description = "{info}Wear it in your arrow slot to boost your damage!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  
		 {              
            icons = { "Gold_Pouch.png" },
            name = "Defender Blue Sphere",
            price = 900,                
            itemtype = 23541,   
			movable = true,			
            count = 1,
            description = "{info}Wear it in your arrow slot to boost your defense!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },  		 	
		{              
            ...
            itemtype = 3215,   
			            movable = false, 
            count = 50,
            description = "{info}Use it to earn charm points! 1 egg = 1 charm.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 
		{              
            icons = { "Charm_Expansion.png" },
			...
			movable = false, 
            count = 250,
            description = "{info}Use it to earn harm points! 1 egg = 1 charm.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        }, 		
        {              
            icons = { "Gold_Pouch.png" },
            ...
            movable = true,       
            count = 1,
            description = "{info}Try out our roulette! May the luck be with you!",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },  
        {              
            icons = { "Gold_Pouch.png" },
...
{
    icons = { "Magical_Water_Orb.png" },
    name = "Imbue Portable",
    price = 900,
    itemtype = 35376,
    movable = false,
    count = 1,
    description = "{info}Imbue your items anywhere!",
    type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
},
        {              
            icons = { "The_Supreme_Cube.png" },
            name = "Supreme Cube Teleporter",
            price = 900,                
            itemtype = 31633,
            movable = false,           
            count = 1,
            description = "{info}Teleports you to different locations in all MazOT!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {              
            icons = { "Old_Radio.png" },
            ...
            movable = false, 
            count = 1,
            description = "{info}Open forge window anywhere!",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },           
        {              
            icons = { "Nightsky_Cupcake.png" },
            name = "Infinite Food",
            price = 250,                
            itemtype = 48240,
            movable = false, 
            count = 1,
            description = "{info}A infinite food that will keep you fed up.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },          
        {
            icons = { "Great_Health_Potion.png" },
            name = "Forge Box Token",
            price = 200,
            itemtype = 22720,
            movable = true, 
            count = 1,
            description = "{info}Use this item to receive a random reward: 1-5 Exalted Cores, 1-5 Dust Containers, or 5-30 Slivers.",
            type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
        },
        {
            icons = { "Great_Health_Potion.png" },
...
-- MazOT ~ Bags
{
    icons = { "Category_Zaoan_Chess_Box.png" },
    name = "Containers",
    parent = "MazOT",
    rookgaard = true,
    state = GameStore.States.STATE_NONE,
    offers = {
        {
            ...
            name = "Galthens Sachel",
            price = 100,
            itemtype = 36813,
            movable = true,
            count = 1,                    
            description = "{info} Container with 44 slots, use it to organize your main backpacks,",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "Bag_You_Desire.png" },
            name = "15 Years Backpack",
            price = 350,
            itemtype = 14674,
            movable = true, 
            count = 1,
            description = "{info} Container with 45 slots and can be imbued with ultimate featherweight.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },      
        {
            icons = { "Primal_Bag.png" },
            name = "20 Years Backpack",
            price = 350,
            itemtype = 24395,
            movable = true, 
            count = 1,
        ...
        {
            icons = { "mazot_backpack.png" },
            name = "MazOT Backpack",
            price = 900,
            itemtype = 44760,
            movable = true, 
            count = 1,
            description = "{info} Grants 8% of all elements protection. Container with 60 slots and can be imbued with ultimate featherweight.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
    },
},
    ...
    offers = {
        {
            ...
            movable = false, 
            count = 1,
            description = "{info} Using it will grant you 50 mp and 100 mp every 2 seconds for 7 days. Relog after use.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "mazot_backpack.png" },
            name = "Regen Boost 30 days",
            price = 900,
            itemtype = 33893,
            movable = false, 
            count = 1,
            description = "{info} Using it will grant you 50 mp and 100 mp every 2 seconds for 30 days. Relog after use.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "mazot_backpack.png" },
            name = "Double HpMp 7 days", --fazendo
            price = 275,
            itemtype = 31674,
            movable = false, 
            count = 1,
            description = "{info} Using it will double your health and mana for 7 days. Relog after use.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },
        {
            icons = { "mazot_backpack.png" },
            name = "Double HpMp 30 days",
            price = 900,
            itemtype = 31675,
            movable = false, 
            count = 1,
            description = "{info} Using it will double your health and mana for 30 days. Relog after use.",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
        },		
...
--end test category
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			{
				icons = { "Ferumbras_Exercise_Dummy.png" },
				name = "Anatomical Skeleton Exercise Dummy",
				price = 900,
				itemtype = 50234,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
			...
			{
				icons = { "Ferumbras_Exercise_Dummy.png" },
				name = "Paramedic Demon Exercise Dummy",
				price = 900,
				itemtype = 50238,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
