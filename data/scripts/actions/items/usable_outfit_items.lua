local outfitConfig = {
	...
	-- decaying defender
	[43899] = { female = 1663, male = 1662, addon = 1, achievement = "Fully Decayed", orangeText = "You earned 1st decaying defender addon." },
	[43900] = { female = 1663, male = 1662, addon = 2, achievement = "Fully Decayed", orangeText = "You earned 2nd decaying defender addon." },

	-- draccoon herald
	[44754] = { female = 1726, male = 1725, addon = 1, achievement = "The Rule of Raccool", orangeText = "You earned 1st draccoon herald addon." },
	[44753] = { female = 1726, male = 1725, addon = 2, achievement = "The Rule of Raccool", orangeText = "You earned 2nd draccoon herald addon." },

	--rootwalker
	[48514] = { female = 1775, male = 1774, addon = 1, achievement = "The Rootwalker", orangeText = "You earned 1st rootwalker addon." },
	[48515] = { female = 1775, male = 1774, addon = 2, achievement = "The Rootwalker", orangeText = "You earned 2nd rootwalker addon." },
}
