...
function flaskPotion.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	--start custom
	--	if potion.health then		
		if potion.health and player:getStorageValue(4535656514) == -1 then
			doTargetCombatHealth(player, target, COMBAT_HEALING, potion.health[1], potion.health[2], CONST_ME_MAGIC_BLUE)
			--item:remove(1)
		elseif potion.health and player:getStorageValue(4535656514) == 1 then
			doTargetCombatHealth(player, target, COMBAT_HEALING, potion.health[1]*1.3, potion.health[2]*1.3, CONST_ME_MAGIC_BLUE)
			--item:remove(1)
		elseif potion.health and player:getStorageValue(4535656514) == 2 then
			doTargetCombatHealth(player, target, COMBAT_HEALING, potion.health[1]*1.6, potion.health[2]*1.6, CONST_ME_MAGIC_BLUE)
			--item:remove(1)	
		elseif potion.health and player:getStorageValue(4535656514) == 3 then
			doTargetCombatHealth(player, target, COMBAT_HEALING, potion.health[1]*2, potion.health[2]*2, CONST_ME_MAGIC_BLUE)
			--item:remove(1)		
		end			
	--	if potion.mana then
		if potion.mana and player:getStorageValue(4535656514) == -1 then
			doTargetCombatMana(0, target, potion.mana[1], potion.mana[2], CONST_ME_MAGIC_BLUE)
		--	item:remove(1)
		elseif potion.mana and player:getStorageValue(4535656514) == 1 then	
			doTargetCombatMana(0, target, potion.mana[1]*2, potion.mana[2]*1.5, CONST_ME_MAGIC_BLUE)
		--	item:remove(1)		
		elseif potion.mana and player:getStorageValue(4535656514) == 2 then	
			doTargetCombatMana(0, target, potion.mana[1]*3, potion.mana[2]*1.8, CONST_ME_MAGIC_BLUE)
		--	item:remove(1)		
		elseif potion.mana and player:getStorageValue(4535656514) == 3 then
			doTargetCombatMana(0, target, potion.mana[1]*4, potion.mana[2]*2.2, CONST_ME_MAGIC_BLUE)
		--	item:remove(1)			
		end
	--end
...
--			if player:getStorageValue("talkaction.potions.flask") ~= 1 then
