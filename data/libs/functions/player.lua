...
do
	local loyaltySystem = {
		...
		titles = {
			[1] = { name = "Scout of Tibia", points = 30 },
			[2] = { name = "Sentinel of Tibia", points = 60 },
			[3] = { name = "Steward of Tibia", points = 90 },
			[4] = { name = "Warden of Tibia", points = 120 },
			[5] = { name = "Squire of Tibia", points = 150 },
			[6] = { name = "Warrior of Tibia", points = 180 },
			[7] = { name = "Keeper of Tibia", points = 210 },
			[8] = { name = "Guardian of Tibia", points = 240 },
			[9] = { name = "Sage of Tibia", points = 270 },
			[10] = { name = "Savant of Tibia", points = 300 },
			[11] = { name = "Enlightened of Tibia", points = 330 },
			[11] = { name = "Noble of Tibia", points = 360 },
		},
		bonus = {
			{ minPoints = 30, percentage = 5 },
			{ minPoints = 60, percentage = 10 },
			{ minPoints = 90, percentage = 15 },
			{ minPoints = 120, percentage = 20 },
			{ minPoints = 150, percentage = 25 },
			{ minPoints = 180, percentage = 30 },
			{ minPoints = 210, percentage = 35 },
			{ minPoints = 240, percentage = 40 },
			{ minPoints = 270, percentage = 45 },
			{ minPoints = 300, percentage = 50 },
			{ minPoints = 330, percentage = 55 },
			{ minPoints = 360, percentage = 60 },
		},
