...
maxPlayers = 0
serverName = "MazOT"
serverMotd = "Welcome to MazOT Global Baiak!"
statusTimeout = 5 * 1000
replaceKickOnLogin = true
maxPacketsPerSecond = 25
maxPlayersOnlinePerAccount = 10
maxPlayersOutsidePZPerAccount = 10
...
--ruseChanceFormulaC = 11

--
ruseChanceFormulaA = 0.065
ruseChanceFormulaB = 0.65
ruseChanceFormulaC = 0.05
--
--ruseChanceFormulaA = 0.0307576
--ruseChanceFormulaB = 0.440697
--ruseChanceFormulaC = 0.026

onslaughtChanceFormulaA = 0.10
onslaughtChanceFormulaB = 0.6
onslaughtChanceFormulaC = 0.25
--onslaughtChanceFormulaA = 0.05
--onslaughtChanceFormulaB = 0.4
--onslaughtChanceFormulaC = 0.05

momentumChanceFormulaA = 0.08
momentumChanceFormulaB = 2.9
momentumChanceFormulaC = 0.10
--momentumChanceFormulaA = 0.05
--momentumChanceFormulaB = 1.9
--momentumChanceFormulaC = 0.05

transcendanceChanceFormulaA = 0.030
transcendanceChanceFormulaB = 0.15
transcendanceChanceFormulaC = 0.009
--transcendanceChanceFormulaA = 0.0127
--transcendanceChanceFormulaB = 0.1070
--transcendanceChanceFormulaC = 0.0073

transcendanceAvatarDuration = 8500
...
houseLoseAfterInactivity = 4 -- days; 0 = never
...
maxSpeedOnFist = 200
disableLegacyRaids = true
disableMonsterArmor = true
